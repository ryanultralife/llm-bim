...
Ops: `create_wall`/`place_door`/`place_window`/`create_room`/`create_slab`/`create_equipment_box`, `place_duct/conduit/cable_tray/column/beam`, takeoffs, `csi_takeoff`, `export_pack`, …
