...
Ops: `create_wall`/`place_door`/`place_window`/`create_room`/`create_slab`, `place_duct/conduit/cable_tray/column/beam`, `duct_takeoff`/`conduit_takeoff`/`cable_tray_takeoff`/`steel_takeoff`, `fitting_takeoff`, `csi_takeoff`, `export_pack`, …
