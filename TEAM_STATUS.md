...
| **WP-CD-ANATOMY-2** | **Claude** | `claude/grok-audit-evolution-w4umwh` | **done** | grid_sides arch/framing · callouts w/ register resolution · match_lines incl. auto-abutting · keynotes+legend · revisions={} auto-clouds from model VCS + table rows · equipment marks ↔ schedule. **Universal anatomy table: zero open gaps.** |
