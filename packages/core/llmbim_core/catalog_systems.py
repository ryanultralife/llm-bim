...
def register_fixtures(into: dict, PartType: type, BomLine: type) -> None:
    ...
    fixtures = [
        # toilets & fixtures
        ("PT-PLB-WC-FLOOR", "Water closet floor-mount elongated", "toilet", 420.0, "vitreous_china", "22 40 00", [700, 400, 750]),
        ("PT-PLB-WC-WALL", "Water closet wall-mount elongated", "toilet", 580.0, "vitreous_china", "22 40 00", [600, 400, 550]),
        ("PT-PLB-WC-ADA", "Water closet ADA floor-mount", "toilet", 520.0, "vitreous_china", "22 40 00", [750, 420, 800]),
        ("PT-PLB-URINAL-WALL", "Urinal wall-hang vitreous", "urinal", 380.0, "vitreous_china", "22 40 00", [400, 350, 700]),
        ("PT-PLB-LAV-WALL", "Lavatory wall-mount 20×18", "lavatory", 280.0, "vitreous_china", "22 40 00", [500, 450, 200]),
        ("PT-PLB-LAV-COUNT", "Lavatory countertop oval", "lavatory", 220.0, "vitreous_china", "22 40 00", [480, 400, 180]),
        ("PT-PLB-SINK-SS-1", "SS kitchen sink single bowl", "sink", 350.0, "ss304", "22 40 00", [600, 500, 200]),
        ("PT-PLB-SINK-SS-2", "SS kitchen sink double bowl", "sink", 480.0, "ss304", "22 40 00", [800, 500, 200]),
        ("PT-PLB-MOP-SINK", "Mop service basin 24×24", "mop_sink", 420.0, "terrazzo", "22 40 00", [600, 600, 300]),
        ...
        ("PT-PLB-FLUSH-VALVE", "Flush valve 1.28 gpf", "flush_valve", 185.0, "brass", "22 40 00", [200, 100, 250]),
        ("PT-PLB-FLUSH-SENSOR", "Sensor flush valve", "flush_valve", 420.0, "brass", "22 40 00", [200, 100, 280]),
        ("PT-PLB-FAUCET-LAV", "Lavatory faucet 0.5 gpm", "faucet", 95.0, "brass", "22 40 00", [150, 50, 150]),
        ("PT-PLB-FAUCET-SENSOR", "Sensor lavatory faucet", "faucet", 280.0, "brass", "22 40 00", [150, 50, 180]),
