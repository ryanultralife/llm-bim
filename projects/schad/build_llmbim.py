...
def schad_sheet_register(p: Project) -> list[dict[str, Any]]:
    ...
    sheets: list[dict[str, Any]] = [
        ...
        # Residual #1 (excellence re-grade): draw the routed model geometry on
        # the MEP sheets — not the old svg_plans.mep_plan_svg note-overlays.
        # Ghost walls give architectural context; A1.1 already keeps MEP off
        # the architectural floor plan. include sets match plan.py groups.
        e(
            "MEP-101",
            "plan",
            level="L1",
            include={"grids", "conduit", "cable_tray", "equipment", "notes"},
            ghost_walls=True,
            tags=True,
            dimensions=False,
            hide_note_disciplines={"M", "P"},
            keynotes=True,
        ),
        e(
            "MEP-201",
            "plan",
            level="L1",
            include={"grids", "pipes", "notes"},
            ghost_walls=True,
            tags=True,
            dimensions=False,
            hide_note_disciplines={"M", "E"},
            keynotes=True,
        ),
        e(
            "MEP-301",
            "plan",
            level="L1",
            include={"grids", "ducts", "equipment", "notes"},
            ghost_walls=True,
            tags=True,
            dimensions=False,
