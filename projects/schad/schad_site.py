...
address was ~800 ft off; the contract APN 000-000-000 parcel was located
via county GIS and confirmed against the [HPLAN] house massing (angled
master wing visible in the aerial).

FACTS:
  APN 000-000-000 = 0.63 ac, ~263 ft (E-W) x ~112 ft (N-S)
...
def site_basis() -> dict:
    ...
    return {
        ...
        'access': {'pts': [(-60.0, -300.0), (-75.0, -120.0),
                           (-95.0, -40.0), (-95.0, 30.0)],
                   'label': 'access lane from S (to Example Way via '
        ...
        'context': [
            ...
            'Meadow/ranch parcels west; Example Way ~300 ft NE '
            '(paved); neighbors 000-000-011 (12.6 ac) etc.',
            'OWNERS ALSO HOLD THE ADJACENT PARCEL [USER 2026-07-13] — '
            'identify APN w/ assessor (candidates: 000-000-011 12.6 ac '
